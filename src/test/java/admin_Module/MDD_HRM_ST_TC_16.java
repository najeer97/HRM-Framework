...
//		driver.findElement(By.xpath("//h4[text()='Add Admin']/../..//input[@name='hr_password']")).sendKeys("qsphead@123");
		 ...
		 */
		//login to the application
		driver.findElement(By.name("hr_email")).sendKeys(xLib.getExpectedDataFromExcel("expdata", "createdUsername"));
		driver.findElement(By.name("hr_password")).sendKeys(xLib.getExpectedDataFromExcel("expdata", "createdUserPassword"));
		...
		//validating the popup
		String actualLoginPopuptextAfterLogou = driver.switchTo().alert().getText();
		if (actualLoginPopuptextAfterLogou.equals(expectedLoginPopuptext)) {
