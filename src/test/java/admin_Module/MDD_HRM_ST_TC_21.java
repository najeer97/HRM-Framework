...
//		driver.findElement(By.xpath("//h4[text()='Add Admin']/../..//input[@name='hr_password']")).sendKeys("qsphead@123");
		...
		//edit the details
		WebElement editButton = driver.findElement(By.xpath("//td[text()='"+xLib.getExpectedDataFromExcel("expdata", "adminName")+"']/..//i[1]"));
		...
		emailTF.clear();
		emailTF.sendKeys(xLib.getExpectedDataFromExcel("expdata", "createdEditedUsername"));
		WebElement passTF = driver.findElement(By.xpath("//h4[text()='Edit Admin']/../..//input[@name='hr_password']"));
		passTF.clear();
		passTF.sendKeys(xLib.getExpectedDataFromExcel("expdata", "createdEditedUserPassword"));
		driver.findElement(By.xpath("//input[@value='"+xLib.getExpectedDataFromExcel("expdata", "adminName")+"']/../../../../..//button[text()='Save']")).click();
		
		//popup for sucessfully updated
		 ...
		 */
		//login to the application
		driver.findElement(By.name("hr_email")).sendKeys(xLib.getExpectedDataFromExcel("expdata", "createdEditedUsername"));
		driver.findElement(By.name("hr_password")).sendKeys(xLib.getExpectedDataFromExcel("expdata", "createdEditedUserPassword"));
		Select selectType = new Select(driver.findElement(By.id("hr_type")));
		selectType.selectByValue(xLib.getExpectedDataFromExcel("expdata", "createdSelectType"));
		driver.findElement(By.name("login_hr")).click();
		
		//validating the popup
		String actualLoginPopuptextAfterLogout = driver.switchTo().alert().getText();
		if (actualLoginPopuptextAfterLogout.equals(expectedLoginPopuptext)) {
